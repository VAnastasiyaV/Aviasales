...
function Ticket({ price, originName1, logo, destination1, departureTime1, arrivalTime1,
    duration1, stopsNumber1, stopNames1, originName2, destination2, departureTime2, arrivalTime2,
    ...
    return (
        <div className='ticket'>
            ...
            <Row gutter={[0, 10]} align='top'>
                <Col span={8}>
                    <p className='ticket__info ticket__info--grey'>{originName1} - {destination1}</p>
                ...
                <Col span={8}>
                    <p className='ticket__info ticket__info--grey'>{originName2} - {destination2}</p>
